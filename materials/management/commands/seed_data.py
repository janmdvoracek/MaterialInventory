...
class Command(BaseCommand):
    help = (
        'Seed the material catalog, depot locations, and employee accounts from CSV files. '
        'Safe to re-run: materials/locations are matched and updated, existing users are left untouched.'
    )
